	...
	<?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?>
		...
		<article <?php post_class( $is_cfo_dossier ? 'cfo-page cfo-dossier-page' : 'cfo-page' ); ?>>
			...
			<?php if ( is_page( 'actualites-legacy' ) ) : ?>
				...
				<?php endwhile; wp_reset_postdata(); ?></div><div class="cfo-method-note"><strong>Notre engagement</strong><p>CFO distingue les sources officielles, professionnelles et médias. Une rumeur ou un bruit de couloir n’est pas présenté comme une actualité.</p></div></div>
